...
# Certificado en Base64 multilínea (como string)
cert_b64 = """MIIG6jCCBdKgAwIBAgIIe5xIbRWLEQ0wDQYJKoZIhvcNAQELBQAwgcUxJjAkBgNV
...
LUx9umW2KeoaBr77lbgcPZnVyic0J7YWY9+gMrmPW/dRaaz1IogEMkb1kJyxPA=="""  # ← pon aquí el bloque completo sin headers BEGIN/END

# 1. Quitar saltos de línea y espacios
cert_b64_clean = "".join(cert_b64.split())

# 2. Decodificar a binario DER
cert_der = base64.b64decode(cert_b64_clean)

# 3. Calcular SHA-256
digest = hashlib.sha256(cert_der).digest()

# 4. Codificar digest en Base64 (para usar en <ds:DigestValue>)
digest_b64 = base64.b64encode(digest).decode("utf-8")

print("DigestValue:", digest_b64)
