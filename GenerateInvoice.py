...
UBLExtensionsVars               = SimpleNamespace(
...
# VersionXML
VersionXMLMainVars              = SimpleNamespace(
                                    IssueTime                   = now.strftime("%H:%M:%S%z")
)
VersionXMLVars                  = SimpleNamespace(
                                    ...
                                    IssueTime                   = VersionXMLMainVars.IssueTime[:-2] + ":" + VersionXMLMainVars.IssueTime[-2:],
...
AccountingSupplierPartyMainVars = SimpleNamespace(
...
AccountingSupplierPartyVars     = SimpleNamespace(
                                    ...
                                    RegistrationAddressID                           = AccountingSupplierPartyMainVars.PhysicalLocationID, #Cambiar si la direccion fiscal del emisor es diferente
                                    RegistrationAddressCityName                     = AccountingSupplierPartyMainVars.PhysicalLocationCityName, #Cambiar si la direccion fiscal del emisor es diferente
                                    RegistrationAddressCountrySubentity             = AccountingSupplierPartyMainVars.PhysicalLocationCountrySubentity, #Cambiar si la direccion fiscal del emisor es diferente
                                    RegistrationAddressCountrySubentityCode         = AccountingSupplierPartyMainVars.PhysicalLocationCountrySubentityCode, #Cambiar si la direccion fiscal del emisor es diferente
                                    RegistrationAddressAddressLine                  = AccountingSupplierPartyMainVars.PhysicalLocationAddressLine, #Cambiar si la direccion fiscal del emisor es diferente
                                    RegistrationAddressCountryIdentificationCode    = AccountingSupplierPartyMainVars.CountryIdentificationCode, #Cambiar si la direccion fiscal del emisor es diferente
                                    RegistrationAddressCountryName                  = AccountingSupplierPartyMainVars.CountryName, #Cambiar si la direccion fiscal del emisor es diferente
...
AccountingCustomerParty         = SimpleNamespace(
...
PaymentMeansVars                = SimpleNamespace(
...
LegalMonetaryTotalVars          = SimpleNamespace(
...
InvoiceLineVars                 = SimpleNamespace(
...
InvoiceLineCUFEVars             = SimpleNamespace(
...
#Construcción CUFE
CUFE                            = ID + VersionXMLVars.IssueDate + VersionXMLMainVars.IssueTime + LegalMonetaryTotalVars.LineExtensionAmount + InvoiceLineCUFEVars.CodImp1 + InvoiceLineCUFEVars.ValImp1 + InvoiceLineCUFEVars.CodImp2 + InvoiceLineCUFEVars.ValImp2 + InvoiceLineCUFEVars.CodImp3 + InvoiceLineCUFEVars.ValImp3 + LegalMonetaryTotalVars.PayableAmount + UBLExtensionsVars.ProviderID + AccountingCustomerParty.PartyIdentification + InvoiceLineCUFEVars.ClTec + VersionXMLVars.ProfileExecutionID
CUFE                            = CUFE.encode()
...
UBLExtensions                   = XML_Parts.UBLExtensions.UBLExtensions(
                                    UBLExtensionsVars.InvoiceAuthorization,
                                    UBLExtensionsVars.StartDate,
                                    UBLExtensionsVars.EndDate,
                                    Prefix,
                                    From,
                                    UBLExtensionsVars.To,
                                    UBLExtensionsVars.ProviderID,
                                    UBLExtensionsVars.ProviderIDDV,
                                    SoftwareID,
                                    SoftwareSecurityCode,
                                    UBLExtensionsVars.AuthorizationProviderID,
                                    UBLExtensionsVars.AuthorizationProviderDV,
                                    CUFE,
                                    UBLExtensionsVars.URL
                                )   

VersionXML                      = XML_Parts.VersionXML.VersionXML(
                                    VersionXMLVars.UBLVersionID,
                                    VersionXMLVars.CustomizationID,
                                    VersionXMLVars.ProfileID,
                                    VersionXMLVars.ProfileExecutionID,
                                    ID,
                                    CUFE,
                                    VersionXMLVars.IssueDate,
                                    VersionXMLVars.IssueTime,
                                    VersionXMLVars.InvoiceTypeCode,
                                    VersionXMLVars.Note,
                                    VersionXMLVars.DocumentCurrencyCode,
                                    VersionXMLVars.LineCountNumeric,
                                    VersionXMLVars.InvoicePeriodStartDate,
                                    VersionXMLVars.InvoicePeriodEndDate
                                )

AccountingSupplierParty         = XML_Parts.AccountingSupplierParty.AccountingSupplierParty(
                                    AccountingSupplierPartyVars.AdditionalAccountID,
                                    AccountingSupplierPartyVars.PartyName,
                                    AccountingSupplierPartyMainVars.PhysicalLocationID,
                                    AccountingSupplierPartyMainVars.PhysicalLocationCityName,
                                    AccountingSupplierPartyMainVars.PhysicalLocationCountrySubentity,
                                    AccountingSupplierPartyMainVars.PhysicalLocationCountrySubentityCode,
                                    AccountingSupplierPartyMainVars.PhysicalLocationAddressLine,
                                    AccountingSupplierPartyMainVars.CountryIdentificationCode,
                                    AccountingSupplierPartyMainVars.CountryName,
                                    AccountingSupplierPartyVars.RegistrationName,
                                    UBLExtensionsVars.ProviderID,
                                    UBLExtensionsVars.ProviderIDDV,
                                    TaxLevelCode,
                                    AccountingSupplierPartyVars.RegistrationAddressID,
                                    AccountingSupplierPartyVars.RegistrationAddressCityName,
                                    AccountingSupplierPartyVars.RegistrationAddressCountrySubentity,
                                    AccountingSupplierPartyVars.RegistrationAddressCountrySubentityCode,
                                    AccountingSupplierPartyVars.RegistrationAddressAddressLine,
                                    AccountingSupplierPartyVars.RegistrationAddressCountryIdentificationCode,
                                    AccountingSupplierPartyVars.RegistrationAddressCountryName,
                                    AccountingSupplierPartyVars.TaxSchemeID,
                                    AccountingSupplierPartyVars.TaxSchemeName,
                                    Prefix,
                                    AccountingSupplierPartyVars.MatriculaMercantil
                                )

AccountingCustomerParty         = XML_Parts.AccountingCustomerParty.AccountingCustomerParty(
                                    AccountingCustomerParty.CustomerAdditionalAccountID,
                                    AccountingCustomerParty.CustomerPartyName,
                                    AccountingCustomerParty.PartyIdentificationType,
                                    AccountingCustomerParty.PartyIdentification,
                                    AccountingCustomerParty.CustomerTaxSchemeID,
                                    AccountingCustomerParty.CustomerTaxSchemeName,
                                    AccountingCustomerParty.CustomerTaxLevelCode
                                )

PaymentMeans                    = XML_Parts.PaymentMeans.PaymentMeans(
                                    PaymentMeansVars.PaymentMeansID,
                                    PaymentMeansVars.PaymentMeansCode,
                                    PaymentMeansVars.PaymentDueDate
                                )

TaxTotal                        = XML_Parts.TaxTotal.TaxTotal(
                                    TaxTotalVars.TaxAmount,
                                    TaxTotalVars.currencyID,
                                    TaxTotalVars.TaxableAmount,
                                    TaxTotalVars.TaxSubtotalTaxAmount,
                                    TaxTotalVars.Percent,
                                    TaxTotalVars.TaxSubtotalTaxSchemeID,
                                    TaxTotalVars.TaxSubtotalTaxSchemeName
                                )

LegalMonetaryTotal              = XML_Parts.LegalMonetaryTotal.LegalMonetaryTotal(
                                    TaxTotalVars.currencyID,
                                    LegalMonetaryTotalVars.LineExtensionAmount,
                                    LegalMonetaryTotalVars.TaxExclusiveAmount,
                                    LegalMonetaryTotalVars.TaxInclusiveAmount,
                                    LegalMonetaryTotalVars.PayableAmount
                                )

TaxTotalInvoiceLine             = XML_Parts.TaxTotal.TaxTotal(
                                    InvoiceLineVars.InvoiceLineTaxAmount,
                                    InvoiceLineVars.InvoiceLinecurrencyID,
                                    InvoiceLineVars.InvoiceLineTaxableAmount,
                                    InvoiceLineVars.InvoiceLineTaxSubtotalTaxAmount,
                                    InvoiceLineVars.InvoiceLinePercent,
                                    InvoiceLineVars.InvoiceLineTaxSubtotalTaxSchemeID,
                                    InvoiceLineVars.InvoiceLineTaxSubtotalTaxSchemeName
                                )

InvoiceLine                     = XML_Parts.InvoiceLine.InvoiceLine(
                                    InvoiceLineVars.InvoiceLineID,
                                    InvoiceLineVars.InvoicedQuantity,
                                    InvoiceLineVars.unitCode,
                                    InvoiceLineVars.InvoiceLineLineExtensionAmount,
                                    TaxTotalVars.currencyID,
                                    InvoiceLineVars.AllowanceChargeID,
                                    InvoiceLineVars.ChargeIndicator,
                                    InvoiceLineVars.AllowanceChargeReason,
                                    InvoiceLineVars.MultiplierFactorNumeric,
                                    InvoiceLineVars.Amount,
                                    InvoiceLineVars.BaseAmount,
                                    TaxTotalInvoiceLine,
                                    InvoiceLineVars.ItemDescription,
                                    InvoiceLineVars.PriceAmount,
                                    InvoiceLineVars.BaseQuantity,
                                    InvoiceLineVars.BaseQuantityUnitCode
                                )
...
KeyInfo                         = f"""<ds:KeyInfo Id="xmldsig-f1a488a1-61f3-4856-b35b-b5d4211b75ee-keyinfo" xmlns:ds="http://www.w3.org/2000/09/xmldsig#" xmlns:xades="http://uri.etsi.org/01903/v1.3.2#"><ds:X509Data><ds:X509Certificate>{PublicCertOneLine}</ds:X509Certificate></ds:X509Data></ds:KeyInfo>"""
...
<ds:Reference URI="#xmldsig-f1a488a1-61f3-4856-b35b-b5d4211b75ee-keyinfo">
<ds:DigestMethod Algorithm="{DigestMethodAlgorithm}"/>
...
# CanonicalSignature = etree.tostring(
#     etree.fromstring(Signature.encode("utf-8")),
#     method="c14n",
#     exclusive=False,
#     with_comments=False,
...
KeyInfoReferenceNode        = SignatureCanonicalXmlTree.xpath(".//ds:Reference[@URI='#xmldsig-f1a488a1-61f3-4856-b35b-b5d4211b75ee-keyinfo']", namespaces=ns)
